import 'package:application/presentation/widgets/musicPlayer1.dart';
import 'package:flutter/material.dart';

import '../../core/colorStyles_const.dart';
import '../../core/textStyles_const.dart';

class ContainerPictureWidget1 extends StatelessWidget {
  final String imgUrl;
  final String title;
  const ContainerPictureWidget1(
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => MusicPlayer1()));
      },
      child: Column(
        children: [
          Padding(

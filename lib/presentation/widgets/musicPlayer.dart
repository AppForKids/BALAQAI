...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  void initPlayer() async {
    await player.setSource(AssetSource('music/damira-erlan.mp3'));
    ...
    return Scaffold(
     appBar: AppBar(
      leading: IconButton(
        ...
        title: Text("Бір үзім нан", style: TextStyles.greyDarkMediumStyle.copyWith(fontSize: 28),),
      ),
      body: Column(
        children: [
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: 
                  Text('Баяғы бір заманда бай мен кедей көрші өмір сүріпті. Олардың араздығы сондай, бірін-бірі көргісі келмейді екен. Байдың үйі кең, әдемі болыпты. Іші толған - алтын мен күміс. Ал кедейдің үйі ағаштан жасалған, төбесін бұтамен жапқан қора екен. Алтын мен күміс түгілі, нанын әзер тауып жепті. Егін егіп, оны суарып, күтіп, орып, өз күнін өзі көріпті.'
                
                'Бір жылы көктемде алапат, су тасқыны болады. Бай алтынын көтеріп ағаштың басына шығып кетеді. Ал кедей болса, бір көмек наныш қойнына салып, ол да ағаштың басына көтеріледі. Су тасқыны он бес күнге созылады. Бір күні қарны ашқан бай кедейге:'
                ...
                style: TextStyles.greyDarkMediumStyle.copyWith(color: ColorStyles.blackColor, fontSize: 14),),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('${((value/60) > 10) ?'' : '0'}${(value/60).floor()}:${((value%60) > 10)? '' : '0'}${(value % 60).floor()}',
                    style: TextStyles.greyDarkSemiBoldStyle.copyWith(
